...
public final class MainPanel extends JPanel {
    ...
    private DefaultComboBoxModel<URLItem> makeTestModel() {
        ...
        model.addElement(new URLItem("http://codekhongkho.com/", image1, true));
        model.addElement(new URLItem("http://codekhongkho.com/java/swing", image1, true));
        model.addElement(new URLItem("http://codekhongkho.com/ubuntu", image1, true));
        model.addElement(new URLItem("http://ngockhuong.com/", image2, true));
        model.addElement(new URLItem("http://codekhongkho.com/", image2, true));
    ...
    public static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("ButtonInComboEditor - Codekhongkho.Com");
